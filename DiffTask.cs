...
namespace ServiceBack
{
    class DiffTask
    {
        ...
        public Boolean StatusDiffTask { get; set; }
        public int Idtask { get; set; }
        public int IdFulltask { get; set; }
        ...
        public DateTime DateBeginBackup { get; set; }
        ...
        public DiffTask(int idfulltask,int idserver, string timelive, int ftp, int shadow, string taskname, string sourse, string dest, string selday, string extension, string password,
            string exeption, string time, string singlecopy)
        {
            sw = File.CreateText(@"ChekTask.txt");
            StatusDiffTask = true;
            IdFulltask = idfulltask;
            Status = 1;
            Idserver = idserver;
            Idsost = 1;
            Ftp = ftp;
        ...
        public DiffTask(int idfulltask,int idtask, int idsost, int idserver, string timelive, int ftp, int shadow, string taskname, string sourse, string dest, string selday, string extension, string password,
            string exeption, string time, string singlecopy) : this(idfulltask, idserver,timelive,ftp,shadow,taskname,sourse,dest,selday,extension,password,exeption,time,singlecopy)
        {
            Idtask = idtask;
            Idsost = idsost;
        }
